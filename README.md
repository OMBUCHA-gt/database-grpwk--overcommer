...
Book_author
Many-to-many mapping of books and authors
Publisher
Book publishers
Book_language
Language list
...
Bookstore customers
Customer_address
Mapping of customers to addresses
Address
All physical addresses
Address_status
Track if address is current/old
Country
Supported countries
Cust_order
Customer orders
...
Shipping_method
Shipping methods (e.g. standard, express)
Order_status
Status list (e.g. pending, delivered)
Order_history
Logs of order status transitions
...
Privileges
Bookstore_admin
Full access to all database actions
ALL PRIVILEGES
Bookstore_staff
Can manage books, customers, orders
